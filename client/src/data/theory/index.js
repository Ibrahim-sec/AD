...
export const theoryModules = {
  'kerberoasting': {
    ...
    xpReward: 150,
    diagram: kerberoastingDiagram, // ADD THIS LINE
...
GetUserSPNs.py contoso.local/user:password -dc-ip 10.0.1.10`
  ...
  'dcsync': {
    ...
    difficulty: 'Advanced',
    xpReward: 200,
    // diagram: dcsyncDiagram, // Add when you create the diagram
...
- Domain Controllers`
  ...
  'pass-the-hash': {
    ...
    difficulty: 'Intermediate',
    xpReward: 120,
    // diagram: passTheHashDiagram, // Add when you create the diagram
